...
@interface fContent : NSObject {
    ...
    NSString *thumbnail;    // for phonots
    float rating;           // for reviews
    NSDate *localStartTime; // for events
    NSDate *localEndTime;   // for events
    float price;            // for real_estate
    float numberOfBeds;     // for real_estate
    float numberOfBaths;    // for real_estate
    float squareFeet;       // for real_estate
    NSString *propertyType; // for real_estate
